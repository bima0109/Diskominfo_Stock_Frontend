...
const PermintaanSekretariatPage = () => {
  ...
  const fetchPermintaan = async () => {
    try {
      ...
      const sekretariatData = data.filter(
        (item) => item.bidang?.nama === "Sekretariat"
      );

      const sortedData = sekretariatData.sort((a, b) =>
  ...
  return (
    <div className="container py-4">
      <h2 className="mb-4">Permintaan Barang - Bidang Sekretariat</h2>
...
export default PermintaanSekretariatPage;
