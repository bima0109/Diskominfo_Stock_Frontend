...
const PermintaanPdkipage = () => {
  ...
  const fetchPermintaan = async () => {
    try {
      ...
      // Filter hanya data dari bidang PDKI
      const filteredData = data.filter(
        (item) => item.bidang?.nama?.toLowerCase() === "pdki"
      );
  ...
  return (
    <div className="container py-4">
      <h2 className="mb-4">Daftar Permintaan Barang - PDKI</h2>
      ...
      {loading ? (
        ...
        <div className="alert alert-info">
          Tidak ada data permintaan untuk bidang PDKI
        </div>
      ) : (
        <>
...
export default PermintaanPdkipage;
