...
const PermintaanStatistikPage = () => {
  ...
  const fetchPermintaan = async () => {
    try {
      ...
      // Filter hanya bidang Statistik
      const statistikData = data.filter(
        (item) => item.bidang?.nama === "Statistik"
      );

      // Urutkan berdasarkan tanggal secara descending
      const sortedData = statistikData.sort((a, b) =>
  ...
  return (
    <div className="container py-4">
      <h2 className="mb-4">Permintaan Bidang Statistik</h2>
...
export default PermintaanStatistikPage;
