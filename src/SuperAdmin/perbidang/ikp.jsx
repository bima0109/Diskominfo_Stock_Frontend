...
const PermintaanikpPage = () => {
  ...
  const fetchPermintaan = async () => {
    try {
      ...
      // Filter hanya data dari bidang IKP
      const filteredData = data.filter(
        (item) => item.bidang?.nama?.toLowerCase() === "ikp"
      );
  ...
  return (
    <div className="container py-4">
      <h2 className="mb-4">Permintaan Barang Bidang IKP</h2>
      ...
      {loading ? (
        ...
        <div className="alert alert-info">
          Tidak ada data permintaan dari IKP
        </div>
      ) : (
        <>
...
export default PermintaanikpPage;
